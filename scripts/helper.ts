...
export function createAnimationObjects(animationTime: number): AnimationObject[] {
  return [
...
export function updatePrimitiveFromAnimation(primitive: any, obj: AnimationObject): void {
  if (obj.id === 'cube' && obj.rotation !== undefined) {
    primitive.setRotation({ x: 0, y: obj.rotation, z: 0 });
  } else if (obj.id === 'torus' && obj.rotationX !== undefined && obj.rotationY !== undefined) {
